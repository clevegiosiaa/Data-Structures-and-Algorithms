...
def should_add_new_data_and_resize():
   ...
   expected_data = [['Content', 'Content', 'Content', 'Content', {'name': 'Aaron', 'yob': '2003', 'phone_no': '08123456789'}, None, None, None],
...
def should_return_data_with_v_and_h_index():
   ...
   assert ((expected_v, expected_h), expected_phone_no_taken) == ((v, h), phone_no_taken), f"Expected Phone Number: {expected_phone_no_taken} in Vertical Index: {expected_v}, Horizontal Index: {expected_h} and got {phone_no_taken} in Vertical Index: {v}, Horizontal Index: {h}."
...
def should_get_new_horizontal_array_with_new_length_2times_after_insert():
   ...
   assert expected_data[0] == temporaryArray[0], f"Expected {expected_data[0]} and got {temporaryArray[0]}."

def after_insert_should_return_telephoneBook_array_with_the_same_length_like_before_insert():
   temporaryArray = [[{'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'}, {'name': 'Andreas', 'yob': '2003', 'phone_no': '08123456789'}, {'name': 'Abigael', 'yob': '2003', 'phone_no': '08123456789'}, None],
                     [None, None, None, None],
                     [None, None, None, None], 
                     [None, None, None, None]]
   ...
   expected_data = [[{'name': 'Agung', 'yob': '2003', 'phone_no': '08123456789'}, {'name': 'Andreas', 'yob': '2003', 'phone_no': '08123456789'}, {'name': 'Abigael', 'yob': '2003', 'phone_no': '08123456789'}, {'name': 'Angel', 'yob': '2003', 'phone_no': '08911111111'}],
                    [None, None, None, None],
                    [None, None, None, None], 
                    [None, None, None, None]]
